...
// Types.set('.*', 'application/octet-stream');
// Types.set('.001', 'application/x-001');
// Types.set('.323', 'text/h323');
// Types.set('.907', 'drawing/907');
// Types.set('.acp', 'audio/x-mei-aac');
// Types.set('.aif', 'audio/aiff');
// Types.set('.aiff', 'audio/aiff');
// Types.set('.asa', 'text/asa');
// Types.set('.asp', 'text/asp');
// Types.set('.au', 'audio/basic');
// Types.set('.awf', 'application/vnd.adobe.workflow');
// Types.set('.bmp', 'application/x-bmp');
// Types.set('.c4t', 'application/x-c4t');
// Types.set('.cal', 'application/x-cals');
// Types.set('.cdf', 'application/x-netcdf');
// Types.set('.cel', 'application/x-cel');
// Types.set('.cg4', 'application/x-g4');
// Types.set('.cit', 'application/x-cit');
// Types.set('.cml', 'text/xml');
// Types.set('.cmx', '	application/x-cmx');
// Types.set('', '');
// Types.set('', '');
// Types.set('', '');
// Types.set('', '');
...
{
    bb = bb.slice(4);
    const result = bb.match(/<td>(.+)<\/td><td>(.+)<\/td><td>(.+)<\/td><td>(.+)<\/td>/);
    if(result)
    {  
        Types.set(result[1],result[2]);
        Types.set(result[3],result[4]);
    }
